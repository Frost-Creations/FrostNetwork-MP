@echo off
TITLE FrostNetwork-MP server software for Minecraft: Bedrock Edition
cd /d %~dp0
...
if exist FrostNetwork-MP.phar (
	set POCKETMINE_FILE=FrostNetwork-MP.phar
) else (
	echo FrostNetwork-MP.phar not found
